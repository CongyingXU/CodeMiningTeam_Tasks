...
def main():
    ...
    for file_name in file_names:
        ...
        if file_name.startswith('memc_') or file_name.startswith('.') or file_name.startswith(
            ...
            all_test_list.extend(cate_target_dataset[int(len_cate_dataset * 2 / 3):])
            ...
            for ele in cate_aim_dataset[:int(len_cate_dataset * 1 / 3)]:
                cate_train_dup += ele + '\n\n'
            for ele in cate_aim_dataset[int(len_cate_dataset * 1 / 3): int(len_cate_dataset * 2 / 3)]:
                cate_valid_dup += ele + '\n\n'
            for ele in cate_aim_dataset[int(len_cate_dataset * 2 / 3):]:
                cate_test_dup += ele + '\n\n'

            for ele in cate_target_dataset[:int(len_cate_dataset * 1 / 3)]:
                cate_train += ele + '\n\n'
            for ele in cate_target_dataset[int(len_cate_dataset * 1 / 3): int(len_cate_dataset * 2 / 3)]:
                cate_valid += ele + '\n\n'
            for ele in cate_target_dataset[int(len_cate_dataset * 2 / 3):]:
                cate_test += ele + '\n\n'
