...
from CVE_HW_CPEDataCollection import processingCPEDictionary
import json
import os


VP_GitRepo_Map_file_path = "LocalData/VP_GitRepoURL_Map.json"
...
class VPGitMap:
    ...
    def read_VP_GIT_REPO_DATA(self):
        if os.path.exists(self.VP_GITREPO_MAP_FILE_PATH):
